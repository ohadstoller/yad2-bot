...
var Yad2Bot = /** @class */ (function () {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 3:
                        _b.sent();
                        return [4 /*yield*/, page.goto(domain, { timeout: 600000 })];
                    case 4:
                        _b.sent();
    ...
    Yad2Bot.prototype.browseMainPage = function (puppeteerPage) {
        return __awaiter(this, void 0, void 0, function () {
            var _this = this;
                        ...
                        getReaEstateTitle: function () { return __awaiter(_this, void 0, void 0, function () {
                            ...
                            return __generator(this, function (_d) {
                                switch (_d.label) {
                                    ...
                                    case 1:
                                        _d.sent();
                                        _b = (_a = puppeteerPage).evaluate;
                                        _c = [function (el) { return el.innerHTML; }];
